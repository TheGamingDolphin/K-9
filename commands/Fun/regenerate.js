...
module.exports = {
  ...
  async execute(interaction) {
    ...
    if (randomNumber === 1) {
      ...
      if (canNickname === true) {
        interaction.member.setNickname("The 9th Doctor");
      }
    } else if (randomNumber === 10) {
      //9 to 10
      await interaction.reply("https://tenor.com/view/-gif-3538028");
      if (canNickname === true) {
        interaction.member.setNickname("The 10th Doctor");
      }
      ...
      if (canNickname === true) {
        interaction.member.setNickname("The 11th Doctor");
      }
    } else if (randomNumber === 13) {
      //11 to 12
      await interaction.reply("https://i.gifer.com/EHuf.gif");
      if (canNickname === true) {
        interaction.member.setNickname("The 12th Doctor");
      }
      ...
      if (canNickname === true) {
        interaction.member.setNickname("The 13th Doctor");
      }
      ...
      if (canNickname === true) {
        interaction.member.setNickname("The Master Doctor");
      }
      ...
      if (canNickname === true) {
        interaction.member.setNickname("The 14th Doctor");
      }
    }
  },
};
